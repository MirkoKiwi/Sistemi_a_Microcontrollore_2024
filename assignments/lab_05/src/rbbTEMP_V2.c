...
float leftHue = 0.0f, rightHue = 120.0f; // Hue for left and right LEDs (in degrees)
int leftRLevel = 0, leftGLevel = 0, leftBLevel = 0;
int rightRLevel = 0, rightGLevel = 0, rightBLevel = 0;

const float hueStep = 1.0f; // Step for hue increment (controls speed of color cycle)
